...
namespace Customer_Managerment.CustomerManagement.Infrastructure.Services
{
    public class GroqService : IGroqService
    {
        ...
        public GroqService(HttpClient httpClient, IConfiguration config)
        {
            ...
            _temperature = double.TryParse(config["GroqSettings:Temperature"], out var t) ? t : 0.3;
                                                            ...
                                                            string userMessage)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync("/chat/completions", groqRequest);
